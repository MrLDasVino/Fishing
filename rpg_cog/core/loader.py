...
from .registry import items, enemies, regions, shops, quests, dungeons, spells, skills
from .base import ItemDef, EnemyDef, RegionDef, ShopDef, QuestDef, DungeonDef, SpellDef, PlaceDef, SkillDef
